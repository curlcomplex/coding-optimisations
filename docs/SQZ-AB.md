...
Fixtures, prompts, model/reasoning, tests and independent review follow the corrected #11 invariant. Two fixtures x two repetitions x two arms. All failed attempts remain countable. Executed harness source was immutable lab commit `f2f6b83a5130bc508ba74e76490202f47281acf7`; the result/docs commits were added only after completion and were not execution source. Results: `results/2026-09-16-sqz-ab.md`.
